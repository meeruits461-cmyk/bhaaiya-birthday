...
// NOTE: Agar aapki images ke naam GitHub par 'Photo1.jpg' hain (P bada), toh neeche 'Photo1.jpg' likhein.
// Agar naam '1.jpg', '2.jpg' hain, toh unhe '1.jpg', '2.jpg' se badal dein.
...
function nextPage(pageNumber) {
    ...
    // Direct fix: Agar Page 7 (Letter page) open ho raha hai, toh message fauran load kar do
    if (pageNumber === 7) {
        executeTypingEffect();
    }
}
...
// Ultra-Safe Encoded Text Storage
